...
from core.model.backbone.UpConvDla import get_upconv_dlanet
    ...
    def __init__(self, base=18, heads=OrderedDict(), head_conv_channel=64, pretrained=True,
        ...
        with self.name_scope():
            ...
            if isinstance(base, int):
                ...
                self._base_network = get_upconv_dlanet(pretrained=pretrained, root=root, use_dcnv2=use_dcnv2, ctx=ctx)
...
if __name__ == "__main__":
    ...
    heatmap, offset, wh = net(
        mx.nd.random_uniform(low=0, high=1, shape=(1, 6, input_size[0], input_size[1]), ctx=mx.cpu()))
